...
function LoanInfoPage({ params }: { params: Promise<{ loanId: string }> }) {
    ...
    return (
        <main className="min-h-dvh dark:bg-gradient-to-br dark:from-gray-900 dark:via-black dark:to-gray-900 bg-gradient-to-br from-gray-50 to-white py-8 px-4 pt-24">
            ...
            <div className="max-w-7xl mx-auto mb-12">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-8 border border-green-100 dark:border-green-800/50 shadow-lg backdrop-blur-sm">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div className="flex items-center gap-6">
                            <div className="bg-gradient-to-br from-green-400 to-green-600 p-4 rounded-2xl shadow-lg">
                                <CircleDollarSign className="text-white drop-shadow-sm" size={28} />
                            </div>
                            <div>
                                <p className="text-gray-600 dark:text-gray-300 text-sm font-medium mb-2">Monto Solicitado</p>
                                {loan.newCantity ? (
                                    <div className="flex items-center gap-4">
                                        <h1 className="text-2xl font-medium text-gray-400 dark:text-gray-500 line-through">
